...
//
// Modified by PM:
// Moved all attributes into data-help-params attribute as JSON object
// Included parameters:
// hidden: hide or show the tooltip
// shift: location of tooltip
// title: title of tooltip
// width: override width of tooltip
//
//
(function() {
  var __slice = [].slice;
  ...
  (function($, window) {
    ...
    chardinJs = (function() {
      ...
      chardinJs.prototype.start = function() {
        ...
        _ref = this.$el.find('*[data-help-params]');
      ...
      chardinJs.prototype._get_param = function(el,param) {
        // <div data-help-params='{"hidden":"false","position":"top","title":"false","text":"false"}'></div>
        var params = (el.getAttribute('data-help-params')) ? JSON.parse(el.getAttribute('data-help-params')) : null;
        switch (param) {
            case 'hidden':
                var hidden = params.hidden || 'false';
                return (hidden == 'true') ? true : false;
            case 'position': return params.position || 'bottom';
            case 'shift': return params.shift || 0;
            case 'text': return params.text || '';
            case 'title': return params.title || null;
            case 'width': return params.width || null;
        }
      };
      ...
      chardinJs.prototype._place_tooltip = function(element) {
        ...
        var shift = this._get_param(element,'shift');
        ...
        switch (this._get_param(element, 'position')) {
          case "top":
          case "bottom":
            target_element_position = this._get_offset(element);
            target_width = target_element_position.width;
            my_width = $(tooltip_layer).width();
            tooltip_layer.style.left = "" + ((target_width / 2) - (tooltip_layer_position.width / 2) + shift) + "px";
            break;
          case "left":
          case "right":
            target_element_position = this._get_offset(element);
      ...
      chardinJs.prototype._show_element = function(element) {
    	...
    	if (this._get_param(element,'hidden'))
    		return false;
        ...
        helper_layer.className = "chardinjs-helper-layer chardinjs-" + (this._get_param(element,'position'));
